        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                id="terms"
                className="w-4 h-4 mt-1 text-orange-600 rounded"
                required
              />
          ...
          <div className="mt-6 p-4 bg-orange-50 rounded-lg text-center">
            <p className="text-sm text-gray-700">
              Want to share your cooking skills?{' '}
              <Link href="/chef/register" className="text-orange-600 font-medium hover:underline">
